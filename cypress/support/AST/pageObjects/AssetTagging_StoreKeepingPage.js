class AssetTagging_StoreKeepingPage
{
    ...
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(2)')
    }
    getTagInputField3()     // Third Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(4)')
    }
    getTagInputField4()     // Fourth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(6)')
    }
    getTagInputField5()     // Fifth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(8)')
    }
    getTagInputField6()     // Sixth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(10)')
    }
    getTagInputField7()     // Seventh Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(12)')
    }
    getTagInputField8()     // Eighth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(14)')
    }
    getTagInputField9()     // Ninth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(16)')
    }
    getTagInputField10()     // Tenth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(18)')
    }
    getTagInputField11()     // Tenth Tag input field
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(20)')
    }

    getLifeTimeInputField()     // প্রথম Life Time input field 
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(1)')
    }
    getSecondLifeTimeInputField()     // Second Life Time input field 
    {
        return cy.get('td input[type="text"][name^="textbox"]:eq(3)')
    }
